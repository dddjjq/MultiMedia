...
public class BreakPointRecord {
    ...
    public static synchronized boolean getBreakPointFlag(Context context) {
        return context.getSharedPreferences("breakpoint", Context.MODE_PRIVATE)
                .getBoolean("needBreakpoint", false);
    }

    public static synchronized void setBreakPointFlag(Context context, boolean flag) {
        context.getSharedPreferences("breakpoint", Context.MODE_PRIVATE)
                .edit().putBoolean("needBreakpoint", flag).apply();
    }
}
